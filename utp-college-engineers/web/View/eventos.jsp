                ...
                <tbody>
                    <%
                        ...
                        while (iterador.hasNext()) {
                            eventos = iterador.next();
                    %>
                    <tr>
                        <td>
                            <div class="news-item">
                                <div class="news-image-container">
                                    <img class="news-img" src="../<%= eventos.getImagen_url() %>" alt="no-photo" />
                                </div>
                                <div class="news-content-container">
                                    <h3 class="news-title"><%= eventos.getTitulo()%></h3>
                                    <span class="news-date"><%= eventos.getFecha()%></span>
                                    <p class="news-description"><%= eventos.getDescripcion()%></p>
